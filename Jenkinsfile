            ...
            steps {
                script {
                    sh """
                        ...
                        kubectl rollout status deployment/postgres-deployment -n ${NAMESPACE} --timeout=500s
                        kubectl rollout status deployment/eureka-server-deployment -n ${NAMESPACE} --timeout=500s
                        kubectl rollout status deployment/face-recognition-service -n ${NAMESPACE} --timeout=500s
                        ...
                        kubectl rollout status deployment/attendance-service -n ${NAMESPACE} --timeout=500s
                    """
                }
            }
        }
            ...
            steps {
                script {
                    sh """
                        ...
                        kubectl rollout status deployment/qr-code-attendance -n ${NAMESPACE} --timeout=500s
                    """
                }
            }
        }
            ...
            steps {
                script {
                    sh """
                        ...
                        kubectl rollout status deployment/frontend -n ${NAMESPACE} --timeout=500s
                    """
                }
            }
        }
